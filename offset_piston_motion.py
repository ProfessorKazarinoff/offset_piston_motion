...
X2 = np.zeros(len(angle))  # array of connecting rod x-positions: Point 2
Y2 = np.zeros(len(angle))  # array of connecting rod y-positions: Point 2
...
ani = animation.FuncAnimation(
    fig, animate, init_func=init, frames=len(X1), interval=40, blit=True, repeat=False
)
